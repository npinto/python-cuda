...
##                            int incy);
cublasSgbmv = cublas.cublasSgbmv
...
cublasSgemv = cublas.cublasSgemv
...
##                            const float *A, int lda, const float *x, int incx, 
##                            float beta, float *y, int incy);
cublasSsbmv = cublas.cublasSsbmv
...
##                            const float *x, int incx, float beta, float *y,
##                            int incy);
cublasSspmv = cublas.cublasSspmv
...
cublasSspr2 = cublas.cublasSspr2
...
##                            float *y, int incy);
cublasSsymv = cublas.cublasSsymv
...
cublasSsyr2 = cublas.cublasSsyr2
...
cublasStbmv = cublas.cublasStbmv
...
##                            const float *A, int lda, float *x, int incx);
cublasStbsv = cublas.cublasStbsv
...
## not in the library !!!
##cublasStmpv = cublas.cublasStmpv
...
##                            const float *AP, float *x, int incx);
cublasStpsv = cublas.cublasStpsv
...
##                            const float *A, int lda, float *x, int incx);
cublasStrmv = cublas.cublasStrmv
...
##                            const float *A, int lda, float *x, int incx);
cublasStrsv = cublas.cublasStrsv
...
##                            int ldc);
cublasSgemm = cublas.cublasSgemm
...
cublasSsymm = cublas.cublasSsymm
...
##                            int ldc);
cublasSsyrk = cublas.cublasSsyrk
...
##                             const float *A, int lda, const float *B, int ldb, 
##                             float beta, float *C, int ldc);
cublasSsyr2k = cublas.cublasSsyr2k
...
##                            float *B, int ldb);
cublasStrmm = cublas.cublasStrmm
...
##                            int m, int n, float alpha, const float *A, int lda,
##                            float *B, int ldb);
cublasStrsm = cublas.cublasStrsm
