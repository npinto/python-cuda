# generated by 'xml2py'
# flags 'cuda.xml -c -d -v -l /usr/local/cuda/lib/libcuda.dylib -o shib.py'
from ctypes import *

_libraries = {}
_libraries['/usr/local/cuda/lib/libcuda.dylib'] = CDLL('/usr/local/cuda/lib/libcuda.dylib')
STRING = c_char_p
...
cuInit = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuInit
...
cuDeviceGet = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceGet
...
cuDeviceGetCount = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceGetCount
...
cuDeviceGetName = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceGetName
...
cuDeviceComputeCapability = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceComputeCapability
...
cuDeviceTotalMem = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceTotalMem
...
cuDeviceGetProperties = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceGetProperties
...
cuDeviceGetAttribute = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuDeviceGetAttribute
...
cuCtxCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxCreate
...
cuCtxDestroy = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxDestroy
...
cuCtxAttach = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxAttach
...
cuCtxDetach = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxDetach
...
cuCtxPushCurrent = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxPushCurrent
...
cuCtxPopCurrent = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxPopCurrent
...
cuCtxGetDevice = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxGetDevice
...
cuCtxSynchronize = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuCtxSynchronize
...
cuModuleLoad = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleLoad
...
cuModuleLoadData = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleLoadData
...
cuModuleLoadFatBinary = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleLoadFatBinary
...
cuModuleUnload = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleUnload
...
cuModuleGetFunction = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleGetFunction
...
cuModuleGetGlobal = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleGetGlobal
...
cuModuleGetTexRef = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuModuleGetTexRef
...
cuMemGetInfo = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemGetInfo
...
cuMemAlloc = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemAlloc
...
cuMemAllocPitch = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemAllocPitch
...
cuMemFree = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemFree
...
cuMemGetAddressRange = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemGetAddressRange
...
cuMemAllocHost = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemAllocHost
...
cuMemFreeHost = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemFreeHost
...
cuMemcpyHtoD = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyHtoD
...
cuMemcpyDtoH = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyDtoH
...
cuMemcpyDtoD = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyDtoD
...
cuMemcpyDtoA = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyDtoA
...
cuMemcpyAtoD = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyAtoD
...
cuMemcpyHtoA = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyHtoA
...
cuMemcpyAtoH = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyAtoH
...
cuMemcpyAtoA = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyAtoA
...
cuMemcpy2D = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpy2D
...
cuMemcpy2DUnaligned = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpy2DUnaligned
...
cuMemcpy3D = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpy3D
...
cuMemcpyHtoDAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyHtoDAsync
...
cuMemcpyDtoHAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyDtoHAsync
...
cuMemcpyHtoAAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyHtoAAsync
...
cuMemcpyAtoHAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpyAtoHAsync
...
cuMemcpy2DAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpy2DAsync
...
cuMemcpy3DAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemcpy3DAsync
...
cuMemsetD8 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD8
...
cuMemsetD16 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD16
...
cuMemsetD32 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD32
...
cuMemsetD2D8 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD2D8
...
cuMemsetD2D16 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD2D16
...
cuMemsetD2D32 = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuMemsetD2D32
...
cuFuncSetBlockShape = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuFuncSetBlockShape
...
cuFuncSetSharedSize = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuFuncSetSharedSize
...
cuArrayCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuArrayCreate
...
cuArrayGetDescriptor = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuArrayGetDescriptor
...
cuArrayDestroy = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuArrayDestroy
...
cuArray3DCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuArray3DCreate
...
cuArray3DGetDescriptor = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuArray3DGetDescriptor
...
cuTexRefCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefCreate
...
cuTexRefDestroy = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefDestroy
...
cuTexRefSetArray = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetArray
...
cuTexRefSetAddress = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetAddress
...
cuTexRefSetFormat = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetFormat
...
cuTexRefSetAddressMode = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetAddressMode
...
cuTexRefSetFilterMode = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetFilterMode
...
cuTexRefSetFlags = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefSetFlags
...
cuTexRefGetAddress = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetAddress
...
cuTexRefGetArray = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetArray
...
cuTexRefGetAddressMode = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetAddressMode
...
cuTexRefGetFilterMode = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetFilterMode
...
cuTexRefGetFormat = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetFormat
...
cuTexRefGetFlags = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuTexRefGetFlags
...
cuParamSetSize = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuParamSetSize
...
cuParamSeti = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuParamSeti
...
cuParamSetf = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuParamSetf
...
cuParamSetv = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuParamSetv
...
cuParamSetTexRef = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuParamSetTexRef
...
cuLaunch = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuLaunch
...
cuLaunchGrid = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuLaunchGrid
...
cuLaunchGridAsync = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuLaunchGridAsync
...
cuEventCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventCreate
...
cuEventRecord = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventRecord
...
cuEventQuery = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventQuery
...
cuEventSynchronize = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventSynchronize
...
cuEventDestroy = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventDestroy
...
cuEventElapsedTime = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuEventElapsedTime
...
cuStreamCreate = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuStreamCreate
...
cuStreamQuery = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuStreamQuery
...
cuStreamSynchronize = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuStreamSynchronize
...
cuStreamDestroy = _libraries['/usr/local/cuda/lib/libcuda.dylib'].cuStreamDestroy
...
__all__ = ['CUdevprop_st', 'cuMemFreeHost', 'cuMemcpyDtoA',
           ...
           'cuTexRefGetFormat', 'cuMemsetD8', 'CUarray_format_enum',
           'cuDeviceGetCount', 'CU_TR_FILTER_MODE_POINT',
           'CUDA_ERROR_LAUNCH_TIMEOUT', 'CU_MEMORYTYPE_DEVICE',
           'CU_AD_FORMAT_UNSIGNED_INT32', 'CUdevice', 'CUfunction',
           'CUfunc_st', 'cuMemcpy2D', 'CU_CTX_SCHED_MASK',
           ...
           'cuMemsetD16', 'cuMemcpyHtoAAsync', 'CUmodule', 'CUtexref',
